class Scene2 extends Phaser.Scene {
    ...
    create ()
    {
        ...
        //personaje
        player = this.physics.add.sprite(400, 300, 'jugador').setSize(170, 450)
        .setScale(0.15);
    ...
    lvlfinish(){
        ...
        var bcontinuar = this.add.image(250, 350, 'bcontinuar').setScale(0.56)
        bcontinuar.setInteractive()
        bcontinuar.on('pointerdown', () => this.scene.start('game2'))

        var bretry = this.add.image(400, 350, 'breintentar').setScale(0.56)
        bretry.setInteractive()
        bretry.on('pointerdown', () => this.reinicio())

        var bquit = this.add.image(550, 350, 'bsalir').setScale(0.56)
        bquit.setInteractive()
        bquit.on('pointerdown',() => (this.salir()))
