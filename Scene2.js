class Scene2 extends Phaser.Scene {
    ...
    create ()
    {
        ...
        goods.children.iterate(function(child){})
    ...
    badies(){
        ...
        if (patron < 0.5){
            ...
            bad.setTexture('virus').setScale(0.5);
        };
        
        if(patron > 0.5){
            bad2.setTexture('barro').setScale(0.5);
        }
        else{
            bad2.setTexture('virus').setScale(0.5);
        };
        
        if(patron < 0.5){
            bad3.setTexture('barro').setScale(0.5);
        }
        else{
            bad3.setTexture('virus').setScale(0.5);
        };

        if(patron < 0.5){
            bad4.setTexture('barro').setScale(0.5);
        }
        else{
            bad4.setTexture('virus').setScale(0.5);
        };
    ...
    goodies(){
        ...
        if (patron < 0.5){
            good.setTexture('bomb');
            //child.score = 5
        }
        else{
            good.setTexture('jeringa').setScale(0.25)
            //child.score = 10
        }

        if (patron > 0.5){
            good2.setTexture('bomb');
            //child.score = 5
        }
        else{
            good2.setTexture('jeringa').setScale(0.25)
            //child.score = 10
        }

        if (patron < 0.5){
            good3.setTexture('bomb');
            //child.score = 5
        }
        else{
            good3.setTexture('jeringa').setScale(0.25)
            //child.score = 10
        }

        if (patron > 0.5){
            good4.setTexture('bomb');
            //child.score = 5
        }
        else{
            good4.setTexture('jeringa').setScale(0.25)
            //child.score = 10
        }
